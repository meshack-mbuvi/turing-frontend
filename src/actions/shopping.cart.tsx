...
// Action types
import { SET_SHOPPING_CART_ID, ADD_TO_SHOPPING_CART, GET_ALL_ITEMS_IN_CART, REMOVE_ITEM_FROM_CART } from './types';
 ...
 * @returns dispatch(...) : a call to action creator
 */
export const RemoveItemFromShopping = (itemId: any) => async (dispatch: any) => {
    try {
        await client.delete(`/shoppingcart/removeProduct/${itemId}`); const cartId = localStorage.getItem('cart_id')
 ...
 */
export const GetItemsInShoppingCart = (cartId: any) => async (dispatch: any) => {
    try {
